...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><i class="Hui-iconfont"></i>  <i class="Hui-iconfont"></i> </span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
			<div class="mt-20">
					...
					<script type="text/html" id="mscList-template">
					  {{each msc}}	
						<tr class="text-c">
                            ...
                            <td class="td-manage"><a style="text-decoration:none" onClick="member_start(this,{{$value.userId}})" href="javascript:;" title="已恢复"><i class="Hui-iconfont"></i></a> 
...
<script type="text/javascript">
	...
	function member_stop(obj,id){
		layer.confirm('确认要删除吗？',function(index){
			...
			$.ajax({
				type : "POST",
				url : "usersInformation.action?method=delectUsers",
				data : {
					userId:id,
